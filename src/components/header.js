        ...
        <header className='header center'>
            ...
            <div className='header__right'>
                ...
                <label htmlFor="burger">
                    ...
                    <input id="burger" type="checkbox" defaultChecked='false' />
                    <nav className='nav burger-menu'>
                        <ul className='burger-menu__ul'>
                            <li className='burger-menu__li'><a class="burger-menu__name" href="#">MENU</a ></li>
                            <li className='burger-menu__li'>
                            <a class="burger-menu__name"  href="#">MAN</a>
                            <ul className='burger-menu__ul'>
                                {arrayManItems.map(item => (
                                    <li className='burger-menu__li-item'><a className='burger-menu__items' href='#'>{item}</a></li>
                                ))}
                            </ul>
                            </li>
                            <li className='burger-menu__li'>
                            <a class="burger-menu__name" href="#">WOMEN</a >
                            <ul className='burger-menu__ul'>
                                {arrayWomenItems.map(item => (
                                    <li className='burger-menu__li-item'><a className='burger-menu__items' href='#'>{item}</a></li>
                                ))}
                            </ul>
                            </li>
                            <li className='burger-menu__li'><a class="burger-menu__name" href="#">KIDS</a >
                            <ul className='burger-menu__ul'>
                                {arrayKidsItems.map(item => (
                                    <li className='burger-menu__li-item'><a className='burger-menu__items' href='#'>{item}</a></li>
                                ))}
                            </ul>
                            </li>
            ...
            <Link className="registratio-icon" to={"/registration"}>
                ...
                <Link className="bascket" to={'/card'}>
