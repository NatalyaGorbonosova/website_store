                            ...
                            if (product) {
                                return(
                                    ...
                                    <div class="cart-content__text-box">
                                        <p class="cart-content__text">Price: <span class="cart-content__text_pink">${product.price}</span></p>
                                        ...
                                        <input class="cart-content__quantity" min={1} type="number" value={item.quantity} 
                                        onChange={(e) => handleQuantityChange(e, item.id)}/></p>
                                    </div>
                                </div>
                                <button class="cart-content__del" onClick={handleRemoveItem(item.id)}>
