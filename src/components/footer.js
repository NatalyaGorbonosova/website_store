import photoSub from '../img/img_bottom.svg'
function Footer() {
    return ( 
        <footer /* className="footer center" */>
          ...
          <div class="subscribe">
              ...
              <div class="subscribe_button">
                  <form  class="subscribe_form" action="#"><input style={{background: '#E1E1E1', border :'0cap'}} type="email" placeholder="Enter Your Email" /></form>
            ...
            <section className='footer'>
                ...
                <div class="icons_footer">
                    <svg className="icon_white_squer" xmlns="http://www.w3.org/2000/svg" width="11" height="16" viewBox="0 0 11 16" fill="none">
